...
2. Перейти на свой канал. Название канала совпадает с именем пользователя (`devopsN`).
...
5. Скопировать код вставки видео в формате HTML со страницы сервиса Yandex Cloud Video (начинается со строки `<iframe ...`) и добавить его с помощью текстового редактора в файл `index.html` после строки `Privet DevOps` (или другой строки, которую вы сюда написали в предыдущем задании) и сохранить его.
